...
- What is the relationship between the knob and the hardware?
  - {param} and {value} relate to **main memory**
  - {param} and {value} relate to **hard disk**
  - {param} and {value} relate to **core counts**
  - Set {param} to {value}
  - {param} and {value} are **unrelated**

- How should I deviate the suggested value?
  - Set {param} **much lower** than {value}
  - Set {param} **slightly below** {value}
  - Set {param} **to** {value}
  - Set {param} **slightly above** {value}
  - Set {param} **much higher** than {value}

- How should I give weight for hints from different sources?
  - The hint on {param} is **not important**
  - The hint on {param} is **slightly important**
  - The hint on {param} is **quite important**
  - The hint on {param} is **very important**
  - The hint on {param} is **extremely important**

Given a text snippet "a reasonable starting value for knob 'shared_buffers' is 25% of the memory in your system" and hardware configurations "RAM = 16GB ", we at first extract the knob name and knob value from it: {shared_buffers, 0.25}.
By answering the first problem, we get expression shared_buffers = 

...
- What is the relationship between the knob and the hardware?
  ...
  - answer 0: {param} and {value} relate to **hard disk**
  - answer 0: {param} and {value} relate to **core counts**
  - answer 0: Set {param} to {value}
  - answer 0: {param} and {value} are **unrelated**

- How should I deviate the suggested value?
  - answer 0: Set {param} **much lower** than {value}
  - answer 0: Set {param} **slightly below** {value}
  - answer 0: Set {param} **to** {value}
  - answer 0: Set {param} **slightly above** {value}
  - answer 0: Set {param} **much higher** than {value}

- How should I give weight for hints from different sources?
  - answer 0: The hint on {param} is **not important**
  - answer 0: The hint on {param} is **slightly important**
  - answer 0: The hint on {param} is **quite important**
  - answer 0: The hint on {param} is **very important**
  - answer 0: The hint on {param} is **extremely important**

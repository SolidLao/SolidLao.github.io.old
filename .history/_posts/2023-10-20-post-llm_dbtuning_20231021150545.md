...
The three questions are answered for each text snippet. For the second and the third problem, the according factors are {0.25, 0.5, 1, 2, 4} and {0, 2, 4, 8, 16}, respectively.

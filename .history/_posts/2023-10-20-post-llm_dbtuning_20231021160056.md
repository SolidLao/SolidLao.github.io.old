...
- assume BERT answers Q1 with answer '0', we get the expression: shared_buffers = 0.25 **\* 16 GB**
- assume BERT answers Q2 with answer '3', we get the expression: shared_buffers = 0.25 \* 16 GB **\* 2**

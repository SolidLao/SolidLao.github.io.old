...
Instead of using language model to answer the questions directly, DB-BART treats the language model as "an encoder" to provide "observation" for RL neural network, and the questions are answered 
